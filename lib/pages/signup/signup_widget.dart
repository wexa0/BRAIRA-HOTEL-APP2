                              ...
                              Padding(
                                ...
                                child: StreamBuilder<List<GuestRecord>>(
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    List<GuestRecord> buttonGuestRecordList =
                                        snapshot.data!;
                                    return FFButtonWidget(
                                      onPressed: () async {
                                        if (functions.checkIfNull(
                                                    _model
                                                    ...
                                                    _model
                                                        ...
                                                        .text,
                                                    buttonGuestRecordList
                                                        .toList()) ==
                                                null ||
                                            functions.checkIfNull(
                                                    _model
                                                        .firstNameTextController
                                                        .text,
                                                    _model
                                                    ...
                                                    buttonGuestRecordList
                                                        .toList()) ==
                                                '') {
                                          if (functions.passwordIsEight(_model
                                          ...
                                          await showDialog(
                                            ...
                                            builder: (alertDialogContext) {
                                              return AlertDialog(
                                                ...
                                                content: Text(functions.checkIfNull(
                                                    _model
                                                        .firstNameTextController
                                                        .text,
                                                    _model
